...
for I0 in light_intensities
    ...
    #Export dataframe
    filename = "data_model_$(I0)_1444s.csv" 
    filename2 = "height_model_$I0.csv"
    path = joinpath("C:/Users/LGPM Bamako/Documents/Results/result_model",filename)
    path2 = joinpath("C:/Users/LGPM Bamako/Documents/Results/result_model",filename2)
    CSV.write(path, df)
    CSV.write(path2, df_height)
end
end
println("Done with calculation")
println("Data is saved at C:/Users/LGPM Bamako/Documents/Results/result_model")
